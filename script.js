...
const tools = {
  raise: {
    en: `
      ...
      <div class="about-tool"><strong>About this tool</strong><p>Enter your current and new monthly salary to see the raise amount, percentage increase, and complete annual difference.</p></div>
  ...
  gosi: {
    en: `
      ...
      <div class="about-tool"><strong>About this tool</strong><p>Estimate the Saudi employee deduction using basic salary, housing allowance, salary month, and contribution history.</p></div>
    ...
    ar: `
      ...
      <div class="about-tool"><strong>عن الأداة</strong><p>احسب الخصم التقريبي للموظف السعودي من الأساسي وبدل السكن حسب شهر الراتب وتاريخ الاشتراك.</p></div>
      <form class="tool-form" id="gosiForm">
  ...
  root: {
    en: `
      ...
      <div class="about-tool"><strong>About this tool</strong><p>Use the 5 Whys method to move from the visible problem to its likely root cause, then record the next action.</p></div>
    ...
    ar: `
      ...
      <div class="about-tool"><strong>عن الأداة</strong><p>استخدم طريقة 5 لماذا عشان تنتقل من المشكلة الظاهرة للسبب الجذري المحتمل، وبعدها سجّل الإجراء التالي.</p></div>
      <form class="tool-form" id="rootForm">
  ...
  shift: {
    en: `
      ...
      <div class="about-tool"><strong>About this tool</strong><p>Create a clear handover note covering production, open issues, safety notes, and actions required for the next shift.</p></div>
    ...
    ar: `
      ...
      <div class="about-tool"><strong>عن الأداة</strong><p>سو ملاحظة تسليم واضحة تشمل الإنتاج، المشاكل المفتوحة، ملاحظات السلامة، والإجراءات المطلوبة للشفت الجاي.</p></div>
      <form class="tool-form" id="shiftForm">
  ...
  kpi: {
    en: `
      <h2>KPI Dashboard</h2>
      <div class="about-tool"><strong>About this tool</strong><p>Enter production, rejected units, planned time, and downtime to get a quick view of target achievement, quality, and availability.</p></div>
    ...
    ar: `
      ...
      <div class="about-tool"><strong>عن الأداة</strong><p>اكتب الإنتاج والوحدات المرفوضة ووقت التشغيل والتوقف عشان تشوف نسبة تحقيق الهدف والجودة والتوافر.</p></div>
      <form class="tool-form" id="kpiForm">
...
function bindTool(tool) {
  ...
  if (tool === 'offer') {
    document.getElementById('offerForm').onsubmit = e => {
      ...
      const best = a === b
        ? (lang==='ar'?'العرضان متساويان بالقيمة السنوية':'Both offers have the same annual value')
        : a > b
          ? `${aName} ${lang==='ar'?'أعلى سنويًا':'has the higher annual value'}`
          : `${bName} ${lang==='ar'?'أعلى سنويًا':'has the higher annual value'}`;
